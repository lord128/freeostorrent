...
<br /><br />
 ...
 <?php
        if(isset($_POST['requete']) && $_POST['requete'] != NULL){
                ...
                if($nb_resultats != 0) {
        ?>
    <h3>Résultats de votre recherche de membre</h3>
    ...
    {
    ?>
                <li><a href="<?php echo SITEURL; ?>/admin/profil.php?membre=<?php echo $donnees['username']; ?>"><?php echo $donnees['username']; ?></a></li>
...
?>
    ...
    <p>Nous n'avons trouvé aucun pseudo de membre pour votre requête "<?php echo htmlspecialchars($_POST['requete']); ?>".
    <br /><br /><a href="recherche-membres.php" style="text-decoration: none;"><input type="button" class="button" value="Faire une recherche avec un autre mot-clé" /></a>
    </p>
    ...
    $req->closeCursor(); // on ferme mysql
        ...
        <p>Vous allez faire une recherche sur notre site concernant les membres inscrits. Tapez une requête pour réaliser une recherche.</p>
                <form action="recherche-membres.php" method="Post">
