...
Mail : webmaster AT freeostorrent.fr<br /><br />

Hébergement :<br />
OVH - Kimsufi - Serveur dédié 100 Mb/s<br /><br />

<h3>A propos et Présentation :</h3>
<?php echo SITENAMELONG; ?> rassemble des OS libres (Systèmes d'exploitation) et des projets libres et les propose au téléchargement par l'intermédiaire du protocole Bittorrent.<br />
Il est complémentaire des projets officiels qui possèdent déjà leurs services Bittorrent (distributions Gnu/Linux ou xBSD, projets diversi, ...) et s'adresse tout particulièrement aux projets plus modestes qui recherchent un moyen simple de partager librement leurs travaux..<br />
<br />
<h3>Un peu d'aide ?</h3>
...
<?php echo SITENAMELONG; ?> propose des médias sous licence libre ou licence de libre diffusion EXCLUSIVEMENT.
