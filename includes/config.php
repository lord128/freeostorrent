...
define('DBUSER','xxxxxxxxxxxxxxxxxxxxxxxxx'); // Mettez ici votre login MYSQL
define('DBPASS','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'); // Mettez ici votre mot de passe MYSQL
define('DBNAME','xxxxxxxxxxxxxxxxxxxx'); // Mettez ici votre nom de base MYSQL
...
define('SITESLOGAN','xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'); // Slogan du site ou explications
...
define('ANNOUNCEPORT','54969'); // port d'announce de XBTT (fixé à 54969 comme dans la base SQL. A changer selon votre besoin.
define('SITEVERSION','xxxxxx'); // N° de version de votre site (affiché sur le pied de page, à droite)
...
// Répertoire des images (à adapter selon vos besoins)
$REP_IMAGES = '/rep/rep/images';
...
$REP_TORRENTS = '/rep/rep/torrents'; // Répertoire des fichiers .torrents
...
$REP_IMAGES_TORRENTS = '/rep/rep/images/imgtorrents'; // Répertoire des images de torrents
...
$REP_IMAGES_AVATARS = '/rep/rep/images/avatars'; // Répertoire des avatars utilisateurs
$EXTENSIONS_VALIDES = array( 'jpg' , 'jpeg' , 'png' ); // Extensions d'images valides

// --- NE PLUS TOUCHER A PARTIR DE LA --- //
